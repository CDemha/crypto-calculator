...
public class ConversionHistoryActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String coinExchangePair = coinController.generateCoinExchangePair(primaryCoin,secondaryCoin,exchange);
        ...
        Log.i("MyApp", coinController.getCoinDataMap().get(coinExchangePair).toString());
