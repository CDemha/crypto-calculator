...
public class DepthConversionHistoryAdapter extends BaseAdapter {
    ...
    public DepthConversionHistoryAdapter(Activity context, CoinController coinController, String coinExchangePair) {
    ...
    public void updateListView(CoinController coinController) {
        ...
        DepthConversionHistoryAdapter.this.notifyDataSetChanged();
    }
